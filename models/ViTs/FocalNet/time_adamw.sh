...
--opt=adamw --amp --amp-dtype=bfloat16 --damping=8.614393475658288e-11 --lr=0.0002954138266570326 --lr_cov=0.006435099410347877 --momentum=0.6598477268421203 --weight-decay=0.016314012579238032 "-j 4"
