...
default_cfgs = {
    "gc_vit_xxtiny": _cfg(
        url="https://huggingface.co/nvidia/GCViT/resolve/main/gcvit_1k_xxtiny.pth.tar",
        crop_pct=1.0,
        input_size=(3, 224, 224),
        crop_mode="center",
    ),
    "gc_vit_xtiny": _cfg(
        url="https://huggingface.co/nvidia/GCViT/resolve/main/gcvit_1k_xtiny.pth.tar",
        crop_pct=0.875,
        input_size=(3, 224, 224),
        crop_mode="center",
    ),
    "gc_vit_tiny": _cfg(
        url="https://huggingface.co/nvidia/GCViT/resolve/main/gcvit_1k_tiny.pth.tar",
        crop_pct=1.0,
        input_size=(3, 224, 224),
        crop_mode="center",
    ),
    "gc_vit_tiny2": _cfg(
        url="https://huggingface.co/nvidia/GCViT/resolve/main/gcvit_1k_tiny2.pth.tar",
        crop_pct=0.875,
        input_size=(3, 224, 224),
        crop_mode="center",
    ),
    "gc_vit_small": _cfg(
        url="https://huggingface.co/nvidia/GCViT/resolve/main/gcvit_1k_small.pth.tar",
        crop_pct=0.875,
        input_size=(3, 224, 224),
        crop_mode="center",
    ),
    "gc_vit_small2": _cfg(
        url="https://huggingface.co/nvidia/GCViT/resolve/main/gcvit_1k_small2.pth.tar",
        crop_pct=0.875,
        input_size=(3, 224, 224),
        crop_mode="center",
    ),
    "gc_vit_base": _cfg(
        url="https://huggingface.co/nvidia/GCViT/resolve/main/gcvit_1k_base.pth.tar",
        crop_pct=1.0,
        input_size=(3, 224, 224),
        crop_mode="center",
    ),
    "gc_vit_large": _cfg(
        url="https://huggingface.co/nvidia/GCViT/resolve/main/gcvit_1k_large.pth.tar",
        crop_pct=1.0,
        input_size=(3, 224, 224),
        crop_mode="center",
    ),
    "gc_vit_large_224_21k": _cfg(
        url="https://drive.google.com/uc?export=download&id=1maGDr6mJkLyRTUkspMzCgSlhDzNRFGEf",
        crop_pct=1.0,
        input_size=(3, 224, 224),
        crop_mode="center",
    ),
    "gc_vit_large_384_21k": _cfg(
        url="https://huggingface.co/nvidia/GCViT/resolve/main/gcvit_21k_large_384.pth.tar",
        crop_pct=1.0,
        input_size=(3, 384, 384),
        crop_mode="squash",
    ),
    "gc_vit_large_512_21k": _cfg(
        url="https://huggingface.co/nvidia/GCViT/resolve/main/gcvit_21k_large_512.pth.tar",
        crop_pct=1.0,
...
def gc_vit_large_224_21k(pretrained=False, **kwargs) -> GCViT:
    ...
    model = _create_gc_vit(
        "gc_vit_large_224_21k", pretrained=pretrained, **model_kwargs
    )
    return model
...
def gc_vit_large_384_21k(pretrained=False, **kwargs) -> GCViT:
    ...
    model = _create_gc_vit(
        "gc_vit_large_384_21k", pretrained=pretrained, **model_kwargs
    )
    return model
...
def gc_vit_large_512_21k(pretrained=False, **kwargs) -> GCViT:
    ...
    model = _create_gc_vit(
        "gc_vit_large_512_21k", pretrained=pretrained, **model_kwargs
    )
    return model
