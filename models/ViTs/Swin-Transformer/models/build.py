...
def build_model(config, is_pretrain=False):
    ...
    #we deliberately set the number of classes to 1000 on dataset imagewoof that has only 10 classes.
    #in this case,  the curvature matrix (gradient outer product) is ill-conditioning.
    print('num of classes', config.MODEL.NUM_CLASSES)
    if model_type == "swin":
