...
_C.TRAIN.BASE_LR = 7e-4  
# Clip gradient norm
_C.TRAIN.CLIP_GRAD = None  #disabled by default
#####################
...
_C.TRAIN.OPTIMIZER.NAME = "ngd"
_C.TRAIN.OPTIMIZER.DAMPING = 2e-3
_C.TRAIN.OPTIMIZER.LR_COV = 2e-2
_C.TRAIN.OPTIMIZER.BETA2 = 1.0 - 1e-3
_C.TRAIN.OPTIMIZER.T = 5
_C.TRAIN.OPTIMIZER.STRUCTURE = "dense" 
_C.TRAIN.OPTIMIZER.DUMMY_INIT = False
_C.TRAIN.OPTIMIZER.DUMMY_SCALING = False
...
_C.AUG.AUTO_AUGMENT = None #this could hurt the performance of AdamW on imagewoo if enabled
# Random erase prob
_C.AUG.REPROB = 0.25
# Random erase mode
_C.AUG.REMODE = "pixel"
...
_C.AUG.RECOUNT = 1
# _C.AUG.MIXUP = 0.8
_C.AUG.MIXUP = 0.0 #this could hurt the performance of AdamW on imagewoof if mixup > 0.0
# Cutmix alpha, cutmix enabled if > 0
# _C.AUG.CUTMIX = 1.0
_C.AUG.CUTMIX = 0.0 #this could hurt the performance of AdamW on imagewoof if cutmix > 0.0
