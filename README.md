...
Note: These matrix operations in `half-precision` are not supported in PyTorch and JAX because they are [numerically unstable](https://github.com/pytorch/pytorch/issues/40427).
