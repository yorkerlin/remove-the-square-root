...
Note: These matrix operations in `half-precision` are not supported in [PyTorch](https://github.com/pytorch/pytorch/issues/40427) and JAX because they are numerically unstable.
